            ...
            *user_ptr_root = insert_user_node(*user_ptr_root, user_id, new_user); // the root of the avl user tree //WORKS
            ...
            if (family_found != NULL)
            {
                ...
                else
                {
                    ...
                    //  Write user to file after successful insertion
                }
            }
            else
            {
...
int main()
{
    ...
    create_family(5, "Gupta", 7829.00, 892.00, &family_tree_ptr, 1);
    create_family(103, "Gupta", 7829.00, 892.00, &family_tree_ptr, 1);

    // addUser(26, "reeti", 89.00, 2, &user_tree_ptr, &family_tree_ptr, 1);
    //  loadUsersFromFile("user.txt", &user_tree_ptr, &family_tree_ptr);
    addUser(3, "reeti", 89.00, 2, &user_tree_ptr, &family_tree_ptr, 1);
    addUser(1, "sara", 90.00, 8, &user_tree_ptr, &family_tree_ptr, 1);
    //  create_family(7, "Gupta", 72828.00, 28282992.00, &family_tree_ptr);
    ...
    Add_expense(5, 3, 2, 789.00, 1111, &user_tree_ptr, 1);
    // Add_expense(2, 6, 2, 890.00, 1209, &user_tree_ptr);
    // Add_expense(2, 5, 0, 890.00, 1209, &user_tree_ptr);
    Add_expense(2, 4, 0, 890.00, 1209, &user_tree_ptr, 1);
    Add_expense(8, 3, 3, 1.00, 911, &user_tree_ptr, 1);
    Add_expense(9, 3, 3, 2.00, 1201, &user_tree_ptr, 1);
    Add_expense(13, 1, 4, 5.00, 909, &user_tree_ptr, 1);
    Add_expense(12, 1, 3, 4.00, 1211, &user_tree_ptr, 1);
    Add_expense(14, 4, 4, 6.00, 1212, &user_tree_ptr, 1);
    /*Add_expense(11, 1, 2, 3.00, 912, &user_tree_ptr, 1);
